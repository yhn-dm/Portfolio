    ...
    <div class="container mx-auto p-6">
        ...
        <form action="{{ route('register') }}" method="POST" class="bg-white p-6 rounded shadow-md">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="name" id="name" class="mt-1 block w-full border-gray-300 rounded shadow-sm focus:ring-blue-500 focus:border-blue-500">
                @error('name')
            ...
            <div>
                <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-semibold px-4 py-2 rounded shadow">S'inscrire</button>
            </div>
        </form>
    </div>
